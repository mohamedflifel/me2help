...
not everyone feels comfortable talking to people around them. me2help was built for those in-between moments — when you need to process something, but don't know where to start. It's a fullstack web application powered by a real AI model (Llama 3.3 70B via Groq) that listens, reflects, and gently challenges your thinking rather than just validating everything you say. The goal isn't to replace human connection — it's to give you a space to think out loud, track your emotional patterns over time.
